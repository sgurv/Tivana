...
#define APDS9960_I2C_ADDR       (0x39) //0x39
...
#define DEFAULT_GLDRIVE         LED_DRIVE_25MA //100
...
#define getMode() (I2C_Master_ReadByte(I2C0_BASE,APDS9960_I2C_ADDR,APDS9960_ENABLE))
...
#define getProximityIntLowThreshold() (I2C_Master_ReadByte(I2C0_BASE,APDS9960_I2C_ADDR,APDS9960_PILT))
...
/* Proximity methods */
#define readProximity() (I2C_Master_ReadByte(I2C0_BASE,APDS9960_I2C_ADDR,APDS9960_PDATA))

/* Gesture methods */
#define isGestureAvailable() (I2C_Master_ReadByte(I2C0_BASE,APDS9960_I2C_ADDR,APDS9960_GSTATUS) & APDS9960_GVALID)

int readGesture(void);


#endif /* DRIVERS_SENSORS_APDS9960_H_ */
